                            ...
                            <form action='usuario.php' method='post' class="user">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input name='primeiro_nome' type="text" class="form-control form-control-user" id="exampleFirstName"
                                            placeholder="Primeiro nome" required>
                                    </div>
                                    <div class="col-sm-6">
                                        <input name='ultimo_nome' type="text" class="form-control form-control-user" id="exampleLastName"
